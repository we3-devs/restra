...
const metadata = {
    ...
    description: "Run your restaurant without the chaos. Restra combines POS, billing, QR ordering, inventory, order tracking, and staff management into one platform.",
    icons: {
        icon: "/logo.svg"
    },
    openGraph: {
        type: "website",
        title: "Restra — Restaurant Management System",
        description: "Run your restaurant without the chaos. POS, billing, QR ordering, inventory, order tracking, and more — built together for modern restaurants.",
        siteName: "Restra",
        images: [
            "/logo.svg"
        ]
