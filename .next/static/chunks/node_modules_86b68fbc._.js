...
function AuthProvider(param) {
    let { client, serverState, onChange, shouldHandleCode, storage, storageNamespace, replaceURL, children } = param;
    var _serverState__state_token;
    const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])((_serverState__state_token = serverState === null || serverState === void 0 ? void 0 : serverState._state.token) !== null && _serverState__state_token !== void 0 ? _serverState__state_token : null);
    ...
    var _client_verbose;
    const verbose = (_client_verbose = client.verbose) !== null && _client_verbose !== void 0 ? _client_verbose : false;
    const logVerbose = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logVerbose]": (message)=>{
            if (verbose) {
                var _client_logger;
                console.debug("".concat(new Date().toISOString(), " ").concat(message));
                (_client_logger = client.logger) === null || _client_logger === void 0 ? void 0 : _client_logger.logVerbose(message);
            }
        }
    ...
    const setToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[setToken]": async (args)=>{
            ...
            if (wasAuthenticated !== (newToken !== null)) {
                await (onChange === null || onChange === void 0 ? void 0 : onChange());
            }
                    ...
                    void ({
                        "AuthProvider.useEffect.listener": async ()=>{
                            ...
                            if (event.key === storageKey(JWT_STORAGE_KEY)) {
                                ...
                                logVerbose("synced access token, is null: ".concat(value === null));
        ...
        "AuthProvider.useCallback[verifyCode]": async (args)=>{
            ...
            while(retry < RETRY_BACKOFF.length){
                try {
                    ...
                    retry++;
                    logVerbose("verifyCode failed with network error, retry ".concat(retry, " of ").concat(RETRY_BACKOFF.length, " in ").concat(wait, "ms"));
                    await new Promise({
    ...
    const verifyCodeAndSetToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[verifyCodeAndSetToken]": async (args)=>{
            ...
            logVerbose("retrieved tokens, is null: ".concat(tokens === null));
            await setToken({
                shouldStore: true,
                tokens: tokens !== null && tokens !== void 0 ? tokens : null
            });
            return tokens !== null;
        }
    ...
    const signIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signIn]": async (provider, args)=>{
            const params = args instanceof FormData ? Array.from(args.entries()).reduce({
                "AuthProvider.useCallback[signIn]": (acc, param)=>{
                    let [key, value] = param;
                    acc[key] = value;
                    return acc;
                }
            }["AuthProvider.useCallback[signIn]"], {}) : args !== null && args !== void 0 ? args : {};
            var _ref;
            const verifier = (_ref = await storageGet(VERIFIER_STORAGE_KEY)) !== null && _ref !== void 0 ? _ref : undefined;
            ...
            if (result.redirect !== undefined) {
                ...
                const { tokens } = result;
                logVerbose("signed in and got tokens, is null: ".concat(tokens === null));
                await setToken({
                    shouldStore: true,
                    tokens
                });
    ...
    const fetchAccessToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[fetchAccessToken]": async (param)=>{
            let { forceRefreshToken } = param;
                ...
                return await browserMutex(REFRESH_TOKEN_STORAGE_KEY, {
                    "AuthProvider.useCallback[fetchAccessToken]": async ()=>{
                        ...
                        if (tokenAfterLockAquisition !== tokenBeforeLockAquisition) {
                            logVerbose("returning synced token, is null: ".concat(tokenAfterLockAquisition === null));
                            return tokenAfterLockAquisition;
                        }
                        var _ref;
                        const refreshToken = (_ref = await storageGet(REFRESH_TOKEN_STORAGE_KEY)) !== null && _ref !== void 0 ? _ref : null;
                        if (refreshToken !== null) {
                            ...
                            logVerbose("returning retrieved token, is null: ".concat(tokenAfterLockAquisition === null));
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const readStateFromStorage = {
                "AuthProvider.useEffect.readStateFromStorage": async ()=>{
                    var _ref;
                    const token = (_ref = await storageGet(JWT_STORAGE_KEY)) !== null && _ref !== void 0 ? _ref : null;
                    logVerbose("retrieved token from storage, is null: ".concat(token === null));
                    await setToken({
                        shouldStore: false,
            ...
            const code = typeof ((_window = window) === null || _window === void 0 ? void 0 : (_window_location = _window.location) === null || _window_location === void 0 ? void 0 : _window_location.search) !== "undefined" ? new URLSearchParams(window.location.search).get("code") : null;
...
function useNamespacedStorage(peristentStorage, namespace) {
    ...
    const storage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useNamespacedStorage.useMemo[storage]": ()=>peristentStorage !== null && peristentStorage !== void 0 ? peristentStorage : inMemoryStorage()
    ...
    const storageKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNamespacedStorage.useCallback[storageKey]": (key)=>"".concat(key, "_").concat(escapedNamespace)
...
async function browserMutex(key, callback) {
    ...
    const lockManager = (_window = window) === null || _window === void 0 ? void 0 : (_window_navigator = _window.navigator) === null || _window_navigator === void 0 ? void 0 : _window_navigator.locks;
...
function browserAddEventListener(type, listener, options) {
    var _window_addEventListener, _window;
    (_window_addEventListener = (_window = window).addEventListener) === null || _window_addEventListener === void 0 ? void 0 : _window_addEventListener.call(_window, type, listener, options);
}
function browserRemoveEventListener(type, listener, options) {
    var _window_removeEventListener, _window;
    (_window_removeEventListener = (_window = window).removeEventListener) === null || _window_removeEventListener === void 0 ? void 0 : _window_removeEventListener.call(_window, type, listener, options);
...
function ConvexAuthProvider(props) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$convex$2d$dev$2f$auth$2f$dist$2f$react$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
        client: authClient,
        storage: storage !== null && storage !== void 0 ? storage : typeof window === "undefined" ? undefined : (_window = window) === null || _window === void 0 ? void 0 : _window.localStorage,
    ...
    const Slot2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.forwardRef((props, forwardedRef)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Children.forEach(children, (maybeSlottable)=>{
            if (isSlottable(maybeSlottable)) {
                ...
                newChildren.push(slottableElement === null || slottableElement === void 0 ? void 0 : (_slottableElement_props = slottableElement.props) === null || _slottableElement_props === void 0 ? void 0 : _slottableElement_props.children);
            } else {
        ...
        var _slottableElement_props;
        const mergedProps = mergeProps(slotProps, (_slottableElement_props = slottableElement.props) !== null && _slottableElement_props !== void 0 ? _slottableElement_props : {});
...
var createSlotError = (ownerName)=>{
    return "".concat(ownerName, " failed to slot onto its children. Expected a single React element child or `Slottable`.");
};
var createSlottableError = (ownerName)=>{
    return "".concat(ownerName, " failed to slot onto its `Slottable`. Expected `Slottable` to receive a single React element child.");
};
...
var DismissableLayer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"]((props, forwardedRef)=>{
    ...
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$react$2d$use$2d$effect$2d$event$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffectEvent"])({
        "DismissableLayer.useEffectEvent[handleKeyDown]": (event)=>{
            if (event.key !== "Escape") {
                return;
            }
    ...
    }["DismissableLayer.useEffectEvent[handleKeyDown]"]);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
...
function usePointerDownOutside(onPointerDownOutside, args) {
    var _globalThis;
    const { ownerDocument = (_globalThis = globalThis) === null || _globalThis === void 0 ? void 0 : _globalThis.document, deferPointerDownOutside = false, isDeferredPointerDownOutsideRef, dismissableSurfaces } = args;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useFocusGuards.useEffect": ()=>{
            ...
            return ({
                "useFocusGuards.useEffect": ()=>{
                    if (count === 1) {
                        guards === null || guards === void 0 ? void 0 : guards.start.remove();
                        guards === null || guards === void 0 ? void 0 : guards.end.remove();
                        guards = null;
                    }
...
//# sourceMappingURL=node_modules_86b68fbc._.js.map