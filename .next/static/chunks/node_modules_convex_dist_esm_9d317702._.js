...
"use strict";
const version = "1.42.1"; //# sourceMappingURL=index.js.map
}),
...
function throwUndefinedValidatorError(context, fieldName) {
    const fieldInfo = fieldName !== void 0 ? ' for field "'.concat(fieldName, '"') : "";
    throw new Error("A validator is undefined".concat(fieldInfo, " in ").concat(context, ". This is often caused by circular imports. See ").concat(UNDEFINED_VALIDATOR_ERROR_URL, " for details."));
}
class BaseValidator {
...
class VObject extends BaseValidator {
   ...
   */ constructor({ isOptional, fields }){
     ...
     */ __publicField(this, "kind", "object");
        globalThis.Object.entries(fields).forEach((param)=>{
            let [fieldName, validator] = param;
            if (validator === void 0) {
   ...
   */ constructor({ isOptional, members }){
     ...
     */ __publicField(this, "kind", "union");
        members.forEach((member, index)=>{
            if (member === void 0) {
                throwUndefinedValidatorError("v.union()", "member at index ".concat(index));
            }
...
function getDocumentSize(value, options) {
    ...
    if (!hasId) {
        if (options === null || options === void 0 ? void 0 : options.customIdLength) {
...
class WebSocketManager {
    ...
    connect() {
        ...
        ws.onopen = ()=>{
            ...
            if (this.pendingNetworkRecoveryInfo !== null) {
                ...
                this.logger.log("Network recovery reconnect saved ~".concat(Math.round(timeSavedMs / 1e3), "s of waiting"));
            }
        };
        ws.onerror = (error)=>{
            this.transitionChunkBuffer = null;
   ...
   */ sendMessage(message) {
    ...
    scheduleReconnect(reason) {
        ...
        const timeoutId = setTimeout(()=>{
            var _this_scheduledReconnect;
            if (((_this_scheduledReconnect = this.scheduledReconnect) === null || _this_scheduledReconnect === void 0 ? void 0 : _this_scheduledReconnect.timeout) === timeoutId) {
                this.scheduledReconnect = null;
                this.connect();
            }
        }, backoff);
   ...
   */ tryReconnectImmediately() {
        ...
        if (this.socket.state !== "disconnected") {
            this._logVerbose("tryReconnectImmediately called but socket state is ".concat(this.socket.state, ", no action taken"));
            return;
        }
        ...
        if (this.scheduledReconnect) {
            ...
            this._logVerbose("would have waited ".concat(Math.round(timeSavedMs), "ms more (backoff was ").concat(Math.round(this.scheduledReconnect.backoffMs), "ms, elapsed ").concat(Math.round(elapsed), "ms)"));
            clearTimeout(this.scheduledReconnect.timeout);
            this.scheduledReconnect = null;
...
class AuthenticationManager {
    ...
    onTransition(serverMessage) {
        ...
        this._logVerbose("auth state is ".concat(this.authState.state, " when handling transition"));
        this.syncState.markAuthCompletion();
        if (this.authState.state === "waitingForServerConfirmationOfCachedToken") {
            var _this_syncState_getAuth;
            this._logVerbose("server confirmed auth token is valid");
            const cachedToken = (_this_syncState_getAuth = this.syncState.getAuth()) === null || _this_syncState_getAuth === void 0 ? void 0 : _this_syncState_getAuth.value;
...
class BaseConvexClient {
   ...
   */ constructor(address, onTransition, options){
     ...
     */ __publicField(this, "markConnectionStateDirty", ()=>{
        ...
        const authRefreshTokenLeewaySeconds = (_options_authRefreshTokenLeewaySeconds = options.authRefreshTokenLeewaySeconds) !== null && _options_authRefreshTokenLeewaySeconds !== void 0 ? _options_authRefreshTokenLeewaySeconds : 10;
        ...
        var _options_initialAuthTokenReuse;
        this.authenticationManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$browser$2f$sync$2f$authentication_manager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthenticationManager"](this.state, {
            ...
            initialAuthTokenReuse: (_options_initialAuthTokenReuse = options.initialAuthTokenReuse) !== null && _options_initialAuthTokenReuse !== void 0 ? _options_initialAuthTokenReuse : false
        });
...
"[project]/node_modules/convex/dist/esm/browser/query_options.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function convexQueryOptions(options) {
    return options;
} //# sourceMappingURL=query_options.js.map
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$browser$2f$query_options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/convex/dist/esm/browser/query_options.js [app-client] (ecmascript)"); //# sourceMappingURL=index.js.map
"use strict";
;
;
;
...
class ConvexReactClient {
   ...
   */ setAuth(fetchToken, onChange, onRefreshChange) {
        ...
        this.sync.setAuth(fetchToken, onChange !== null && onChange !== void 0 ? onChange : ()=>{}, onRefreshChange);
    }
    /**
   * Clear the current authentication token if set.
   */ clearAuth() {
...
function useQuery_experimental(options) {
    var _options_throwOnError;
    const throwOnError = (_options_throwOnError = options.throwOnError) !== null && _options_throwOnError !== void 0 ? _options_throwOnError : false;
    const queryReference = typeof options.query === "string" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeFunctionReference"])(options.query) : options.query;
    const skip = options.args === "skip";
    const argsObject = !skip ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$common$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseArgs"])(options.args) : {};
    const queryName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$server$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFunctionName"])(queryReference);
    const queries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useQuery_experimental.useMemo[queries]": ()=>skip ? {} : {
                query: {
                    query: queryReference,
                    args: argsObject
                }
            }
    }["useQuery_experimental.useMemo[queries]"], // Stringify args so args that are semantically the same don't trigger a
    // rerender. Saves developers from adding `useMemo` on every args usage.
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [
        JSON.stringify((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$values$2f$value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convexToJson"])(argsObject)),
...
function usePaginatedQueryInternal(query, args, options) {
    let throwOnError = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
    ...
    const [results, maybeLastResult, maybeError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
...
function usePaginatedQuery_experimental(queryOrOptions, args, options) {
    ...
    var _queryOrOptions_throwOnError;
    const throwOnError = isObjectOptions ? (_queryOrOptions_throwOnError = queryOrOptions.throwOnError) !== null && _queryOrOptions_throwOnError !== void 0 ? _queryOrOptions_throwOnError : false : true;
    const initialOptions = isObjectOptions ? {
        initialNumItems: queryOrOptions.initialNumItems
    } : options;
    if (typeof (initialOptions === null || initialOptions === void 0 ? void 0 : initialOptions.initialNumItems) !== "number" || initialOptions.initialNumItems < 0) {
        throw new Error("`options.initialNumItems` must be a positive number. Received `".concat(initialOptions === null || initialOptions === void 0 ? void 0 : initialOptions.initialNumItems, "`."));
    }
    ...
    if (!("paginatedQuery" in resultsObject)) {
        ...
        if (isObjectOptions) {
            return reshapeToObjectForm2(internalResult2);
        }
    ...
    if (isObjectOptions) {
        return reshapeToObjectForm2(internalResult);
    }
...
function ConvexProviderWithAuth(param) {
    ...
    const isAuthenticated = authProviderAuthenticated && (isConvexAuthenticated !== null && isConvexAuthenticated !== void 0 ? isConvexAuthenticated : false);
...
function ConvexAuthStateFirstEffect(param) {
    let { authProviderAuthenticated, fetchAccessToken, authProviderLoading, client, setIsConvexAuthenticated, setIsRefreshing } = param;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConvexAuthStateFirstEffect.useEffect": ()=>{
            ...
            if (authProviderAuthenticated) {
                client.setAuth(fetchAccessToken, {
                    ...
                    "ConvexAuthStateFirstEffect.useEffect": (isRefreshing)=>{
                        if (isThisEffectRelevant) {
...
function AuthRefreshing(param) {
    let { children } = param;
    const { isAuthenticated, isRefreshing } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$ConvexAuthState$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useConvexAuth"])();
...
//# sourceMappingURL=node_modules_convex_dist_esm_9d317702._.js.map